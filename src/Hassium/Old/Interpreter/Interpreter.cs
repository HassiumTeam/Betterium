...
namespace Hassium
{
    public class Interpreter
    {
        ...
        private OldAstNode code;

        public Interpreter(OldAstNode code)
        {
        ...
        public void Execute()
        {
            foreach (OldAstNode node in this.code.Children)
            {
        ...
        private void executeStatement(OldAstNode node)
        {
            if (node is CodeBlock)
                foreach (OldAstNode anode in node.Children)
        ...
        private object evaluateNode(OldAstNode node)
        {
